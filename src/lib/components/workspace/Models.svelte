<script lang="ts">
	...
	const cloneModelHandler = async (model) => {
		if ((model?.info?.base_model_id ?? null) === null) {
			...
			goto('/sensai/workspace/models/create');
		}
	};
...
<div class=" flex w-full space-x-2">
	...
	<div>
		<a
			...
			href="/sensai/workspace/models/create"
		>
			<svg
				xmlns="http://www.w3.org/2000/svg"
				viewBox="0 0 16 16"
...
<a class=" flex space-x-4 cursor-pointer w-full mb-2 px-3 py-2" href="/sensai/workspace/models/create">
